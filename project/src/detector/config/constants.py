...
METRICS_FOR_STAMPA = ["jsd", "tvd", "l1", "cosine_sim", "entropy_real", "entropy_generated"]
METRICS_FOR_STAMPA_GENERATED = ["jsd", "tvd", "l1", "cosine_sim", "entropy"]

metricsForStampa = METRICS_FOR_STAMPA
metricsFForStampaGen = METRICS_FOR_STAMPA_GENERATED
