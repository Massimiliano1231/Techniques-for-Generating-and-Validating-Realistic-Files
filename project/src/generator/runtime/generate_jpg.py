...
from generator.formats.jpg_helper import SOI, EOI, emit_segment, sample_next
...
def load_jpeg_model():
    ...
    if _JPEG_MODEL is None:
        ...
        _JPEG_MODEL = alias_prob, alias_idx, marker_to_idx, p_marker
    return _JPEG_MODEL


def generate_jpeg(target_len: int) -> bytes:
    alias_prob, alias_idx, marker_to_idx, p_marker = load_jpeg_model()
